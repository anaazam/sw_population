...
/* Do-file for aggregated population estimation of sex workers */
...
tempname AggPresults

postfile `AggPresults' counter ll_null ll_model df AIC BIC  ///
LRchi_null LRp_null LRdf_null lambda LMtest 	///
T_Poiss T_left T_right using "AggPresults.dta", replace
...
foreach x of local covsets {
	...
	* LM test of overdispersion (poisson vs negative binomial):
	...
	scalar result11 = lmtest_`counter'[1,1]
	...
	* Computing confidence intervals using point estimate and variance:
	...
	post `AggPresults' (`counter') (result2) (result3) (result4) (result5)  ///
...
tempname AggZresults

postfile `AggZresults' counter ll_null ll_model df AIC BIC  ///
LRchi_null LRp_null LRdf_null							 ///
Zelter Z_left Z_right using "AggZresults.dta", replace
...
foreach x of local covsets {
	...
	* Computing confidence intervals using point estimate and variance:
	...
	post `AggZresults' (`counter') (result2) (result3) (result4) (result5)  ///
