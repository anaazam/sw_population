...
log using belgium.log, replace

/* Do-file for population estimation of sex workers in Belgium */
...
postfile `BPresults' counter ll_null ll_model df AIC BIC  ///
LRchi_null LRp_null LRdf_null LMtest							 ///
T_Poiss T_left T_right using "BPresults.dta", replace
...
foreach x of local covsets {
	...
	* Computing confidence intervals using point estimate and variance:
	...
	post `BPresults' (`counter') (result2) (result3) (result4) (result5)  ///
...
postfile `BZresults' counter ll_null ll_model df AIC BIC  ///
LRchi_null LRp_null LRdf_null							 ///
Zelter_ Z_left_ Z_right_ using "BZresults.dta", replace
...
foreach x of local covsets {
	...
	* Computing confidence intervals using point estimate and variance:
	...
	post `BZresults' (`counter') (result2) (result3) (result4) (result5)  ///
